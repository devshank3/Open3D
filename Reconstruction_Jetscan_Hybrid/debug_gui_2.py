...
def CC():
    os.system('python3 run_regref.py config/intel/config_debug2.json --register --refine')
...
C=tkinter.Button(root,text="Registration Refine (point_to_plane, FGR)",font=('Glacial Indifference',20),fg='black',width=30,bg="#ff8533",relief='flat',command= CC)
